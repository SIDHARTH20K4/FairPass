...
export const eventFactoryABI = [
	...
	},
	{
		"inputs": [
			...
			{
				"internalType": "enum EventImplementation.EventType",
				"name": "EventType",
				"type": "uint8"
			},
			{
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract EventImplementation",
				"name": "",
				"type": "address"
			}
		],
...
export const eventImplementationABI = [
	{
		"inputs": [
			{
				"internalType": "string",
